            ...
            if (ts.isSourceFile(node)) {
                ...
                if (ts.isClassDeclaration(node) && node.decorators) {
                    return [
                        ...
                        ts.createVariableDeclarationList([ts.createVariableDeclaration(ID, undefined, ts.createIdentifier(node.name.getText()))], ts.NodeFlags.Const),
